!function (e) {
    ...
    function (e, t, n) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            clone: function (e) {
                ...
                var n = "", i = e.constructor === Array ? [] : {};
                if ("object" === (void 0 === e ? "undefined" : o(e))) {
                    if (window.JSON) n = JSON.stringify(e), i = JSON.parse(n); else for (var a in e) i[a] = "object" === o(e[a]) ? t(e[a]) : e[a];
                    return i
                }
            },
            ...
            checkEnv: function (e) {
                var t = window.navigator.userAgent || "", n = [];
    ...
    function (e, t, n) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            hasProperty: function (e, t) {
                ...
                var e = navigator.userAgent.toLowerCase().match(/gdtmobsdk\/[0-9\.]*$/), t = e && e[0].split("/"),
                    n = "",
                    o = "";
                return t && t.length > 0 && (n = t[0], o = t[1]), {name: n, version: o}
            }, getOs: function () {
    ...
    function (e, t, n) {
        ...
        var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
            ...
            return e && "function" == typeof Symbol && e.constructor === Symbol && e !== Symbol.prototype ? "symbol" : typeof e
        }, i = c(n(14)), a = c(n(15)), r = c(n(17)), d = c(n(4)), s = c(n(18));
        ...
        !function () {
            var e = {
                ...
                tbsFlag: "tbs",
                init: function (t) {
                    var n = e.getReqCond(t), o = t.posid || t.placement_id, i = t.count || e.CONST.MIN_LOADCOUNT,
                        r = t.appid || t.app_id, d = t.from, s = t.tbs_config, c = t.onComplete;
                    e.restrict[o] = new a.default({
                        ...
                        } else console.log("tbsjs not ready")
                    }) : (e.conflist.push({
                        posId: o,
                        count: i,
                        platform: "mobile",
                        ...
                        context: {appid: r, req: {support_https: g.isHttpsProtocol() ? 1 : 0}, common: n},
                        tempContext: {
                            appid: r,
                            req: {support_https: g.isHttpsProtocol() ? 1 : 0},
                ...
                bindAntiSpam: function (t, n) {
                    ...
                    var o = n.dom, a = n.isIframe;
                    e.antiSpamConf[t] = new i.default({dom: o, isIframe: a})
                },
                ...
                getReqCond: function (t) {
                    var n = navigator.userAgent.toLowerCase() || "", o = t.muidtype || t.muid_type, i = t.muid,
                        a = t.site_set, r = t.information_info || t.informationInfo,
                        d = g.getCookie("debug_h5sdk_adId"),
                        s = g.getCookie("debug_h5sdk_nomatch"), c = (g.getCookie("debug_h5sdk_module"), {
                            c_os: "",
                    ...
                    t && t.display_type && t.display_type === e.CONST.DISPLAY_TYPE_INTERSTITIAL && (c.inline_full_screen = 1);
                ...
                loadAd: function (t, n) {
                    for (var o = e, i = !1, a = [], d = 0; d < o.originConflist.length; d++) if (o.originConflist[d].context = JSON.parse(JSON.stringify(o.originConflist[d].tempContext)), t == o.originConflist[d].posId) {
                ...
                checkAndLoadNativeAd: function () {
                    var t = e;
                    t.conflist && t.conflist.length > 0 && !t.qbsLoaded && g.loadJS("//qzonestyle.gtimg.cn/qzone/biz/comm/js/qbs.js", function () {
                        t.qbsLoaded = !0;
                ...
                refreshConnParam: function (e) {
                    if (_.isTBSPageView() && e && e.tempContext && e.tempContext.common) {
                        if (!e.tempContext.common.conn) {
                            ...
                            }) : g.pingHot("nobrowserconnection") : g.pingHot("nobrowser")), -1 !== t.indexOf("TBS/") && -1 !== t.indexOf("MQQBrowser/")) if (window.tbs) if (window.tbs.network) {
                                var n = window.tbs.network.type();
                                n ? e.tempContext.common.conn = "wifi" == n ? 1 : "2g" == n ? 2 : "3g" == n ? 3 : "4g" == n ? 4 : 0 : g.pingHot("notbsnetworktype")
                            } else g.pingHot("notbsnetwork"); else g.pingHot("notbs");
                ...
                exposeTemplateNativeAd: function (t, n) {
                    var o = e, i = o.loadedAd[t];
                    if (i) {
                        var a = {placement_id: i.posid, advertisement_id: i.adData.cl};
                ...
                clickTemplateNativeAd: function (t, n, o) {
                    var i = e, a = i.loadedAd[n], r = e.getAntiSpam(a.posid);
                    if (a) {
                        //note 点击
                        console.log('click nativead');
                        var d = a.adData && a.adData.template_id, s = r.da, c = r.db, p = r.g, l = r.sc, u = r.ec, f = {
                            down_x: t.pageX,
                            down_y: t.pageY,
                            up_x: t.pageX,
                            up_y: t.pageY,
                ...
                creatInterstitialNativeContainer: function () {
                    var t = e.CONST.WRAP_TYPE_INTERSTITIAL, n = document.getElementById(t);
                    return n ? [t, n] : ((n = document.createElement("div")).id = t, document.body.appendChild(n), [t, n])
                },
                renderTemplateNativeAd: function (t, n) {
                    var o = g.$("#" + n), i = e.loadedAd[t && t.tid], a = i && i.template,
                        r = i && i.adData && i.adData.reltarget, d = i && i.adData && i.adData.producttype,
                        s = i && i.adData && i.adData.ext && i.adData.ext.pkg_name,
                        c = (i && i.adData && i.adData.ext && i.adData.ext.appid, i.posid), p = {packagename: s};
                    if (e.getAdConf(c).display_type === e.CONST.DISPLAY_TYPE_INTERSTITIAL && (o = e.creatInterstitialNativeContainer()[1], n = e.creatInterstitialNativeContainer()[0]), n && o && t && t.tid && t.advertisement_id && t.placement_id && i && a && t && t.tid && t.advertisement_id && t.placement_id && i && a) try {
                        ...
                        }, p); else if (e.checkEnvironment("inQW") && window.tbs && window.tbs.package && d == e.CONST.PRODUCT_TYPE.OPEN_APP && 1 == r) {
                ...
                getTargetIframe: function (e, t) {
                    var n = document.getElementsByTagName("iframe"),
                        o = e.contentDocument || e.contentWindow && e.contentWindow.document, i = null;
                    if (o) return o;
                    if (null !== t) {
                ...
                renderTemplateAd: function (t, n, o) {
                    var i = e.getTargetIframe(t, o), a = 0;
                    if (!1 !== i) {
                        var r = setInterval(function () {
                            if (++a > 20) return clearInterval(r), !1;
                            if (!y.checkIsHidden(t) && (i && "complete" == i.readyState || i && "interactive" == i.readyState)) if (i.body.scrollHeight > 150) t.style.height = i.body.scrollHeight + "px"; else {
                                if (!(i.body.getElementsByTagName("div").length >= 1)) return !1;
                                t.style.height = i.body.getElementsByTagName("div")[0].scrollHeight + "px"
                            }
                        }, 500), d = i.createElement("meta");
                ...
                setIframeElSize: function (t, n, o) {
                    var i = document.documentElement.clientWidth, a = document.documentElement.clientHeight,
                        r = e.getAdConf(o.placement_id), d = e.loadedAd[o && o.tid], s = 0, c = 0;
                    if (r.display_type === e.CONST.DISPLAY_TYPE_INTERSTITIAL) {
                        if (d && d.adData) {
                            var p = d.adData.template_width, l = d.adData.template_height;
                        ...
                        scrolling: "no",
                        transition: "all 0.05s ease-in-out 0s"
                    }), e.setBannerContainerHeight(n)) : e.setStyle(t, {width: "100%", scrolling: "no"})
                },
                ...
                processTemplateNativeAd: function (t, n, o, i) {
                    for (var a = [], r = n.data, d = e.getAdConf(t), s = "", c = 0; c < r.length; c++) {
                        var p = {tid: r[c].traceid, advertisement_id: r[c].cl, placement_id: t, item: c};
                        a.push(p)
                    }

                    //note 控制展示
                    console.log(d.opt && d.opt.ide);
                    d.display_type === e.CONST.DISPLAY_TYPE_BANNER ?
                        ((s = e.checkAdConf(d)).data = a,
                            0 === s.ret && a.length > 0 ?
                                (o.onComplete && o.onComplete(s),

                                        d.opt && d.opt.ide ? setTimeout(function () {
                                                e.exposeTemplateNativeAd(p.tid)
                ...
                closeTemplateNativeAd: function (t) {
                    if ("object" === (void 0 === t ? "undefined" : o(t)) && t.hasOwnProperty("traceid")) {
                        var n = e.loadedAd[t.traceid].posid, i = e.getAdConf(n);
                        if (i.display_type === e.CONST.DISPLAY_TYPE_INTERSTITIAL) {
                            var a = e.CONST.WRAP_TYPE_INTERSTITIAL, r = document.getElementById(a);
                ...
                processinQWCustomNativeAd: function (t, n, o, i) {
                    for (var a = n.data, r = [], d = 0; d < a.length; d++) {
                        var s = a[d].producttype, c = a[d].reltarget, p = {packagename: a[d].ext.pkg_name};
                        if (s == e.CONST.PRODUCT_TYPE.OPEN_APP && 1 == c) 1 != window.tbs.package.isApkInstalled(p, function (e) {
                        }) && r.push(i.data[d]); else r.push(i.data[d])
                    }
                    i.data = r, o.onComplete && o.onComplete(i)
                },
                processinQBCustomNativeAd: function (t, n, o, i) {
                    var a = n.data, r = [], d = a.length;
                    ...
                    for (var c = 0; c < a.length; c++) {
                        var p = a[c].producttype, l = a[c].reltarget, u = {packagename: a[c].ext.pkg_name};
                    ...
                    o.est_f && o.est_f(n.ret, n.data),
                        n.template && n.template.length > 0 ?
                            ...
                            e.checkEnvironment("inQB") ?
                                ...
                                e.checkEnvironment("inQW") && window.tbs && window.tbs.package && window.tbs.package.isApkInstalled ?
                                    e.processinQWCustomNativeAd(t, n, o, i) :
                                    e.processCustomNativeAd(t, n, o, i)
                },
                setNativeLoadAd: function (t, n, o, i) {
                    if (void 0 === t) return !1;
                    e.loadedAd[t] = {posid: n, adData: o, template: i}
                },
                ...
                doExpose: function (t, p) {
                    var n = "";
                    var c = e.getAdConf(t.placement_id);
                    ...
                    if (!e.exposureOids[n]) {
                        ...
                        c.opt.loaded.push(p),
                            c.opt.p = p, c.est_e && c.est_e();

                        //note 判断点击
                        if (c.opt && c.opt.elc > 0 && c.opt.enck && !c.opt.ack) {
                            c.opt.ack = !0;

                            function dock() {
                                var ad = e.loadedAd[c.opt.p].adData,
                                    pt = ad.cfg.pt == 2 ? 1 : ad.cfg.pt == 1 ? 3 : 2,
                                    elc = c.opt.elc == 2 ? 3 : c.opt.elc == 3 ? 6 : 2;
                                GDT.getter && (c.carousel = 0, GDT.getter(c.opt.curl + pt + "&acttype=" + ad.acttype, function (anti) {
                                    anti &&
                                    typeof anti.aa != "undefined" &&
                                    typeof anti.ab != "undefined" && (t.s = encodeURIComponent(JSON.stringify({
                                        down_x: parseInt(anti.aa),
                                        down_y: parseInt(anti.ab),
                                        up_x: parseInt(anti.ba),
                                        up_y: parseInt(anti.bb),
                                        tid: ad && ad["template_id"],
                                        da: anti.da.toString(),
                                        db: anti.db.toString(),
                                        g: anti.g.toString(),
                                        sc: anti.sc.toString(),
                                        ec: anti.ec.toString()
                                    })), e.doClick(t, c.opt.p, elc));
                                }));
                            }

                            c.opt.elc == 3 && typeof c.opt.bck == "function" ? c.opt.bck(dock) : setTimeout(function () {
                                dock()
                            }, c.opt.dt)
                        }
                    }
                },
                doClick: function (t, p, elc) {
                    for (var n = "", i = e, a = "", d = 0; d < i.originConflist.length; d++)
                        if (t.placement_id == i.originConflist[d].posId) {
                            if (i.originConflist[d].from &&
                                i.originConflist[d].from == i.tbsFlag &&
                                i.tbsDomain == document.domain) return;
                            break
                        }
                    if (t && t.s && t.advertisement_id && t.placement_id) {
                        if (a = t.traceid ?
                            ...
                            r.default.evnet(120521, "do_click", t), !e.exposureOids[a])
                            return r.default.evnet(120528, "ERR_do_click", {params: JSON.stringify(t)}), {
                                ret: 1,
                                msg: "error，不能进行点击跳转"
                            };

                        //note 控制点击
                        var cf = e.getAdConf(t.placement_id);
                        var ad = e.loadedAd[p].adData;
                        ...
                        t.s = encodeURIComponent(JSON.stringify(c));

                        function j(l) {
                            //note 点击跳转记录
                            elc = elc || 1;
                            cf.est_c(c, ad.cfg.pt, elc);
                            if (elc === 3 && typeof cf.opt.cws === 'function') cf.opt.cws(l);
                        ...
                        if (n = i.rlMap[t.advertisement_id + t.placement_id] + "&s=" + t.s, i.isAndroidApp[t.advertisement_id]) {
                            ...
                            else n = ~~n.indexOf("&s_lp") > 0 ? n : n + "&acttype=" + i.CONST.ACTTYPE_DOWNLOAD, j(n)
                        } else i.isIOSApp[t.advertisement_id] && navigator && navigator.userAgent && -1 !== navigator.userAgent.indexOf("MicroMessenger") && (n += "&platform=wx&target=appstore"), j(n)
                    }
                },
                getTopUrl: function () {
                ...
                TEMPLATE_EMPTY: [100002, "返回的广告模板为空，请检查请求返回数据排查问题"]
            }, n = {
                status: {code: 0, msg: ""},
                posid: "",
                appid: "",
                ...
                getRespStatus: function (e) {
                    ...
                    switch (e) {
                        case"NO_POSID":
                            t = {code: -1, msg: "placement_id is empty."};
                            break;
                        case"NO_APPID":
                            t = {code: -2, msg: "app_id is empty."};
                            break;
                        case"NO_ONCOMPLETE":
                            t = {code: -3, msg: "onComplete callback is empty."};
                            break;
                        case"ENV_FAIL":
                            t = {code: -4, msg: "env fail"};
                            break;
                        case"CB_NOT_FUN":
                            t = {code: -5, msg: "callback is not a function"};
                            break;
                        case"ENV_NOT_SUPPORT":
                            t = {code: -6, msg: "env is not support"};
                            break;
                        case"INIT_SUCC":
                        default:
                            t = {code: 0, msg: "reward ad init success"}
                    }
                    return t
                },
            ...
            c.prototype = {
                loadAd: function () {
                    var e = {instance_id: this.instance_id};
            ...
            var p, l, u, f = {
                ...
                initBanner: function (e) {
                    var t = f, n = [640, 480, 320, 240], o = [100, 75, 50, 38], i = 480, a = 75, r = f.getOs();
                    if (window.screen) i = window.screen.width, a = window.screen.height, "ios" == r && (i *= window.devicePixelRatio, a *= window.devicePixelRatio); else if (document.body) {
                ...
                getWidthHeight: function () {
                    var e = document.body.clientWidth || 640, t = document.body.clientHeight || 100;
                    if (e > t) {
                        var n = e;
                        e = t, t = n
                    }
                ...
                checkParam: function (e) {
                    return !new RegExp("[`~!@#$^&*()=|{}':;',\\[\\].<>/?~！@#￥……&*（）&mdash;—|{}【】‘；：”“'。，、？]").test(e)
                },
                getUid: function () {
                    var e = g.getParameter("sid"), t = g.getParameter("openid"), n = g.getParameter("openkey"), o = "";
                ...
                renderWindow: function (e, t, n, o, i) {
                    ...
                    var d = e.appid || e.app_id, s = e.muidtype || e.muid_type, c = e.muid,
                        p = e.posid || e.placement_id,
                        l = !!r.BannerCb.onBannerLoaded, u = e.information_info || e.informationInfo,
                        h = e.taglist || e.tag_list, w = e.posclass || e.pos_class, _ = r.inter_posw, v = r.inter_posh;
                    ...
                    var C = e.containerid || e.container_id, A = 0, S = 0;
                    ...
                    if (b += "&visiturl=" + encodeURIComponent(x), b += "&referrerurl=" + encodeURIComponent(window.location != window.parent.location ? document.referrer : ""), b += "&iframeheight=" + m.BANNER_IFRAME_HEIGHT, b += "&iframewidth=" + m.BANNER_IFRAME_WIDTH, C && g.$("#" + C)) {
                    ...
                    if (P.setAttribute("style", "display:none"), P.id = "gdt_banner_popup_wrap", "banner" == e.adType) {
                        ...
                        if (C && g.$("#" + C)) L = "", g.$("#" + C).appendChild(P); else (R = g.$("#gdt-" + r.posid)).parentNode.insertBefore(P, R);
                        P.setAttribute("style", L + ";left:0px;bottom:0;width:100%;display:none")
                    } else {
                        var M = "width:30px;height: 30px;", B = document.createElement("div");
                        ...
                        k = 36, D = 12;
                        a = a.replace(/{OTHER}/, 'display: inline-block;"  id="gdth_popup_wrap').replace(/{W}/, r.inter_posw + "px").replace(/{H}/, r.inter_posh + "px").replace(/{LOGO}/, '<div id="gdt_logo" style="background-image:url(//qzonestyle.gtimg.cn/open_proj/proj-gdt-toufang/img/ad-sign/logo-ad-s.png);background-size: cover;width:' + k + "px;height:" + D + 'px;position: absolute;right: 0;bottom: 0;"><i ></i></div>').replace(/{IFRID}/, "gdt_ifr").replace(/{CLOSEDIV}/, '<a href="javascript:" style="' + M + 'position: absolute;right:4px;top:5px;text-indent: -9999px;overflow: hidden;z-index: 100;" onclick="GDT.closeWindow(this)" class="icon_close">关闭</a>'), B.innerHTML = a, B.style.display = "none", document.body.appendChild(B)
                    }
                ...
                initPostMsg: function () {
                    f.bindPostMsg || (f.bindPostMsg = !0, f.onorientationChange("banner"), g.addEvent(window, "message", function (e) {
                        ...
                        if ((t = g.skipHttpOrHttpsProtocol(t)) && t == f.adDomain && e && e.data) {
                            ...
                            if (o || n) {
                                var o = n.result;
                                if ("fail" == o) f.closeWindow(), f.IntersCb.onFail && f.IntersCb.onFail(); else if ("success" == o) f.showBannerWin(); else if (n.op) if ("checkToLoadTBS" == n.op) _.isTBSsupported() && _.tbsLoad(); else if ("mqzoneclick" == n.op) g.pingHot("mqzoneclicked"), QZAppExternal.callSchema(function (e) {
                                }, {url: "mqzone://arouse/webview?source=push&url=" + n.url + "&safari=0&version=1"}); else if ("mclick" === n.op) {
                                    var i = n.isApp;
                                ...
                                } else if ("androidAppOtherClick" === n.op) location.href = decodeURIComponent(n.url); else if ("loaededad" === n.op) f.adready = !0, f.IntersCb.onInterstitialLoaded(), g.$(".gdth_popup_floater").style.marginBottom = -this.inter_posh / 2 + "px"; else if ("googleInterstitialLoaded" === n.op) f.adready = !0, f.IntersCb.onInterstitialLoaded(), g.$("#gdt_logo").style.display = "none", g.$(".gdth_popup_floater").style.marginBottom = -this.inter_posh / 2 + "px"; else if ("showbigsize" == n.op) f.adready = !0, f.IntersCb.onInterstitialLoaded(), g.$("#gdt_ifr").style.width = "580px", g.$("#gdt_ifr").style.height = "900px", g.$("#gdt_logo").style.right = "0", g.$(".gdth_popup_floater").style.marginBottom = "-450px", f.fixFullAdPos(290, 450), window.addEventListener("orientationchange", function (e) {
                                    f.fixFullAdPos(290, 450)
                                }); else if ("checkHidden" == n.op) {
                                    var a = n.type, r = n.posid, d = n.flag, s = y.getBaseNode(a);
                                    w.checkHidden(s, r, a, d)
                                } else if ("exposeCheck" == n.op) {
                                    a = n.type, r = n.posid;
                                    var c = n.apurl, p = n.tplType;
                                    w.prepare(a, r, c, p, l)
                                } else if ("getImgStatus" == n.op) {
                                    a = n.type, r = n.posid;
                                    var l = n.isImgComplete;
                                    w.imgExposeCheck(a, r, c, p, l)
                                } else if ("showBanner" == n.op) f.showBannerWin(); else if ("noAd" == n.op) f.showBannerWin(), f.BannerCb.onBannerLoaded && f.BannerCb.onBannerLoaded({
                                    ret: 1,
                                    msg: "no ad"
                ...
                getParameter: function (e, t) {
                    var n = new RegExp("(\\?|#|&)" + e + "=([^&#]*)(&|#|$)"), o = location.href.match(n);
                ...
                showWindow: function () {
                    if (!f.windowShowing && f.adready) {
                        ...
                        var e = g.$("#gdt_ifr"), t = f.adDomain;
                        t = g.isHttpsProtocol() ? "https://" + t : "http://" + t, e.contentWindow.postMessage(JSON.stringify({op: "exp"}), t), f.fixNormalAdPos()
                    }
                },
                ...
                collectDPI: function () {
                    window.setTimeout(function () {
                        var e = window.screen.width || 1e4, t = 4;
                ...
                webpEnabled: !1, loadJS: function (e, t) {
                    var n = document.getElementsByTagName("head")[0], o = document.createElement("script");
                    o.onload = o.onreadystatechange = o.onerror = function () {
                ...
                return e.getBaseNode = function (e) {
                    ...
                    for (var t = !1, n = e && e.style, o = 0; e != document && o <= 20;) if (o++, e != document && n && "none" != n.display && "hidden" != n.visibility && "collapse" != n.visibility) e = e && e.parentNode; else if (n && "none" == n.display || n && "hidden" == n.visibility || n && "collapse" == n.visibility) {
                        t = !0;
                        break
                    }
                    return t
            ...
            window.GDT = {
                loadGDT: f.loadGDT, closeWindow: f.closeWindow, showWindow: f.showWindow, log: function () {
                    ...
                    if (t) f.init(t); else for (var o = 0, i = n.length; o < i; o++) f.init(n[o]);
            ...
            var v = window.TencentGDT, b = function () {
                if (v && v.length) {
            ...
            !function () {
                if (!window.jsInited) {
                    ...
                    r.default.evnet(120313, "sdk_init", {
                        host: (function () {
                            return new URL(window.TencentGDT[0].vl).host
                        })(),
        ...
        var i = function () {
            function e(t) {
                !function (e, t) {
                    ...
                    isIframe: !!t.isIframe,
                    ad: {dom: t.dom, width: "", height: ""},
                    touchStart: {stamp: 0, x: -999, y: -999},
                    touchEnd: {stamp: 0, x: -999, y: -999},
                    click: {stamp: 0, x: -999, y: -999},
                    drag: t.drag || 0,
            ...
            return o(e, [{
                ...
                key: "getAntiSpamInfo", value: function () {
                    var e = this.state, t = (e.ad, e.touchStart), n = e.touchEnd, o = e.click, i = e.drag,
                        a = e.closeBtn,
                        r = e.playtime, d = e.changeWindow, s = o.stamp || n.stamp, c = this.state.ad.dom.offsetHeight,
    ...
    function (e, t, n) {
        ...
        var d = 3e5, s = function () {
            ...
            return o(e, [{
                key: "getRestrictMap", value: function () {
                    var e = this;
                ...
                key: "setRestrictData", value: function (e) {
                    var t = {};
                ...
                key: "getConfigRate", value: function (e) {
                    try {
                        var t = a.default.getItem("__GDT_H5_RST_MAP"), n = a.default.getItem("__GDT_H5_RST_EXPIRATION"),
                            o = (new Date).getTime(), i = JSON.parse(t).restrict_map;
                        if (n && i && i.rate) o - n >= (i.rate || 1e4) && (e(), a.default.setItem("__GDT_H5_RST_EXPIRATION", o)); else e(), a.default.setItem("__GDT_H5_RST_EXPIRATION", o)
                    } catch (t) {
                ...
                key: "hitRestrictMap", value: function (e, t) {
                    try {
                        var n = a.default.getItem("__GDT_H5_RST_MAP"), o = JSON.parse(n).restrict_map, i = t, r = !1;
    ...
    function (e, t, n) {
        ...
        t.default = function (e, t, n) {
            var i = "", a = null, r = "__gdt_jp_" + (new Date).getTime() + parseInt(1e5 * Math.random()),
                d = null !== t.timeout ? t.timeout : 6e3, s = encodeURIComponent,
    ...
    function (e, t, n) {
        ...
        }(), a = n(2), r = (o = a) && o.__esModule ? o : {default: o};
        var d = function () {
            function e() {
                !function (e, t) {
                    if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                }(this, e), this.state = {cache: []}, this.props = {debug: r.default.getParam("debug") || !1}, this.initSDK()
            }

            return i(e, [{
                key: "evnet", value: function (e, t, n) {
                    try {
                ...
                key: "feedback", value: function () {
                    var e = this.state.cache;
                    if (e.length > 0) for (var t in e) window.BeaconAction && window.BeaconAction.onEvent(e[t].eventID, e[t].eventName, e[t].params)
                }
            }, {
                key: "initSDK", value: function () {
                    var e = this, t = this.props.debug, n = document.createElement("script"),
                        c = window.TencentGDT[0].opt.est;
                    n.src = t ? c + "/mig_op/beacon/js/v113/beacon_release_jrlt.js?appkey=JS05KY1G393HQI&vc=1.0.1" :
                        c + "/mig_op/beacon/js/v113/beacon_release.js", document.body.appendChild(n), n.onload = function () {
                        e.feedback()
                    }
                }
            }]), e
    ...
    function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
        var o, i = n(4), a = (o = i) && o.__esModule ? o : {default: o};
        var r = {
